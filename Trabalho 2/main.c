...
int meneuInserirNumeroEmEstrutura(){
    int posicao, valor, retorno = -1;
    printf("Insira a posição da estrutura auxiliar na estrutura principal:\n");
    scanf("%d", &posicao);
...
int main()
{
    ...
    while (!sair)
    {
        ...
        { //inserir
            //TODO
            ret = meneuInserirNumeroEmEstrutura();
            if (ret == SUCESSO)
            {
